...
AppMutex                 = {#AppMutex}
; No elevation needed — installs per-user if not admin
...
[Tasks]
Name: "desktopicon";    Description: "Crea un'icona sul {cm:DesktopFolder}"; GroupDescription: "Icone aggiuntive:";
Name: "startupentry";   Description: "Avvia automaticamente con Windows";    GroupDescription: "Opzioni di avvio:"; Flags: checked
